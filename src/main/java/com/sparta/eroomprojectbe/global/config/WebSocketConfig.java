...
//                .setAllowedOriginPatterns("http://localhost:8080","http://localhost:3000", "https://eroom-challenge.com", "https://www.eroom-challenge.com") // 해당 도메인에서만 웹소켓 연결 허용. 개발 중에는 모두 허용하되 필요에 따라 조정
