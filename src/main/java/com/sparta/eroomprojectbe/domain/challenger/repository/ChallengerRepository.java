...
public interface ChallengerRepository extends JpaRepository<Challenger, Long> {
    ...
    @Query("SELECT new com.sparta.eroomprojectbe.domain.member.dto.mypage.ChallengeWithRoleDto(c.challenge, c.role) FROM Challenger c WHERE c.member.memberId = :memberId ORDER BY c.challenge.createdAt DESC")
